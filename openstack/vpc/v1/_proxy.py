...
class Proxy(proxy2.BaseProxy):
    ...
    def create_public_ip(self, **attrs):
        ...
        :param dict attrs: Keyword arguments which will be used to create
            ...
            comprised of the properties on the PublicIP class.
            Available attributes include:
            ...
            * ``bandwidth_name``: The bandwidth name. The value is a string of
                ...
                underscores (_), and hyphens (-).
                Mandatory when share_type is set to PER and is optional when
                share_type is set to WHOLE with 'bandwidth_id' specified.
            * ``bandwidth_size``: The bandwidth size. The value ranges from
                1 Mbit/s to 300 Mbit/s.
                This parameter is mandatory when share_type is set to PER and
                is optional when share_type is set to WHOLE with 'bandwidth_id'
                specified.
            * ``bandwidth_id``: The ID of the bandwidth. The value can be the
                ID of the bandwidth whose type is set to WHOLE. Optional.
            * ``bandwidth_share_type``: The bandwidth sharing type. The value
